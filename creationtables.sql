...
('UKR','Pavlo Tumoshchenko','M',32,'Pantathlon'),
('FJI','Semi Kunatani','M',28,'Rugby a sept'),
('FJI','Osea Kolinisau','M',33,'Rugby a sept'),
('KOR','Kim So-Hui','F',24,Taekwondo'),
('ESP','Eva Calvo Gomez','F',27,'Taekwondo'),
('CHE','Martina Hingis','F',38,'Tennis'),
('ROU','Florin Mergea','M',33,'Tennis'),
('CHN','Ma Long','M',30,'Tennis de table'),
('GER','Petrissa Solja','F',24,'Tennis de table'),
('ITA','Niccolo Campriani','M',31,'Tir'),
('ITA','Chiara Cainero','F',40,'Tir'),
('KOR','Chang Hye-jin','F',31,'Tir a l'arc'),
('FRA','Jean-Charles Valladont','M',29,'Tir a l'arc'),
('AUT','Thomas Springer','M',34,'Triathlon'),
('EST','Kaidi Kivioja','F',25,'Triathlon'),
('NOR','Krisian Blummenfelt','M',24,'Triathlon'),
('FRA','Charline Picon','F',33,'Voile'),
('SLO','Vasilij Zbogar','M',43,'Voile'),
('BRA','Barbara Seixas','F',31,'Beach-volley'),
('BRA','Agatha Bednarczuk','F',35,'Beach-volley'),
('SRB','Jovana Vesovic','F',31,'Volleyball'),
('SRB','Suzana Cebic','F',34,'Volleyball'),
